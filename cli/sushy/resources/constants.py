...
ENTRY_TYPE_EVENT = 'The log contains Redfish-defined messages'
ENTRY_TYPE_SEL = 'The log contains Legacy IPMI System Event Log entries (SEL)'
ENTRY_TYPE_MULTIPLE = 'The log contains Multiple log entry types'
ENTRY_TYPE_OEM = 'The log contains OEM-defined messages'
